    ...
    <div class="inner">
        <nav>
            ...
            <ul>
                ...
                <li><img src="{{ asset('image/pic.webp')}}" alt="" style="height: 30px; border-radius:50%;"><a id="navbarDropdown" class="nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
